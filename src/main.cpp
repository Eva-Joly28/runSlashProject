...
int main()
{
 ...
 //   std::string pathBarreVie = "assets//full_vie.png";
 //   sf::Texture textureBarreVie;
 //   if (!textureBarreVie.loadFromFile(pathBarreVie)) {
 //       return -1;
 //   }
 ...
 //           pathBarreVie = "assets//moins_full_vie.png";
 //           spriteBarreVie->setTexture(textureBarreVie);
	//	}
 //       else if (pv <= 25 && pv != 0) {
 //           pathBarreVie = "assets//presque_vide_vie.png";
 //           spriteBarreVie->setTexture(textureBarreVie);
 //       }
	//	else if (pv == 0) {
 //           pathBarreVie = "assets//mort_vie.png";
	//		spriteBarreVie->setTexture(textureBarreVie);
	//	}

 //       

 //       if (!player1.gethitboxBounds().findIntersection(epeiste.gethitboxBounds())) {
	//		epeiste.updateJoueur(&player1);
 //     
 //       }
 //       else {
